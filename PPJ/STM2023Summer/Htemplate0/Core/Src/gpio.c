...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, ADF4351_LE_Pin|ADF4351_DAT_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = ADF4351_LE_Pin|ADF4351_DAT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
/* USER CODE BEGIN 2 */
void OPenRelay(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
	HAL_GPIO_WritePin(GPIOx,GPIO_Pin,1);
}	
void CloseRelay(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
