...
#define AD9910_SCLK_H 			HAL_GPIO_WritePin(SCK_GPIO_Port,	SCK_Pin,	GPIO_PIN_SET);
...
#define AD9910_CS_H			HAL_GPIO_WritePin(CSB_GPIO_Port,	CSB_Pin,	GPIO_PIN_SET);	
...
#define AD9910_SCLK_L 			HAL_GPIO_WritePin(SCK_GPIO_Port,	SCK_Pin,	GPIO_PIN_RESET);
...
#define AD9910_CS_L 			HAL_GPIO_WritePin(CSB_GPIO_Port,	CSB_Pin,	GPIO_PIN_RESET);		 			     
