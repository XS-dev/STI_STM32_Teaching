...
#define AD9854_SCLK_DOWN   P3OUT &=~BIT3
#define AD9854_UPDATE_UP   P2OUT |= BIT4
#define AD9854_UPDATE_DOWN P2OUT &=~BIT4
#define AD9854_UPDATE_OUT   P2OUT |= BIT4
#define AD9854_UPDATE_IN 	P2OUT &=~BIT4
#define AD9854_SDIO_UP     P3OUT |= BIT1
#define AD9854_SDIO_DOWN   P3OUT &=~BIT1
#define AD9854_IO_RESET_UP    P3OUT |= BIT0
#define AD9854_IO_RESET_DOWN  P3OUT &=~BIT0
...
#define AD9854_OSC_OFF  	P6OUT &=~BIT5
