...
//  AD9834_Set_Freq(0,500000); //Set the output frequency of 15MHz
}
...
void AD9834_Gpio_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(AD9834_RST_GPIO_Port, AD9834_RST_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = SCLK_Pin|AD9834_RST_Pin;
