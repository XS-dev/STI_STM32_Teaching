...
//	HAL_ADC_DeInit(&hadc1);
	...
	if (HAL_ADC_Start_DMA(&hadc1, (uint32_t *)adc1_data, 1) != HAL_OK)
	{
...
//	adc_init();
  ...
  while (1)
  {
		for(u16 temp = 0;temp<900;temp++)
		{
			freq = 100+temp;
			Write_frequence(2,freq*100000);
			Delay_Us(100);
			adc_saopin();
			adata = (float)(adc1_data[0])/65536*3300;
			printf("%f\r\n", adata);
		}		
//	
    /* USER CODE END WHILE */
