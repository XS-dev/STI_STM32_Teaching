...
#define AD9834_RESET_H      HAL_GPIO_WritePin(RST_GPIO_Port,    RST_Pin,  				GPIO_PIN_SET)
...
#define AD9834_RESET_L      HAL_GPIO_WritePin(RST_GPIO_Port,    RST_Pin,  				GPIO_PIN_RESET)
