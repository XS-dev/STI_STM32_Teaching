...
#define ads1115_I2C_SCL_H HAL_GPIO_WritePin(SCL_GPIO_Port,	SCL_Pin,	GPIO_PIN_SET);	
#define ads1115_I2C_SCL_L HAL_GPIO_WritePin(SCL_GPIO_Port,	SCL_Pin,	GPIO_PIN_RESET);	

#define ads1115_I2C_SDA_H HAL_GPIO_WritePin(SDA_GPIO_Port,	SDA_Pin,	GPIO_PIN_SET);	
#define ads1115_I2C_SDA_L HAL_GPIO_WritePin(SDA_GPIO_Port,	SDA_Pin,	GPIO_PIN_RESET);	
