...
extern uint16_t shumaguan_flag;
extern uint16_t temptimer0;
extern uint16_t temptimer1;
extern uint32_t sendata 	;			
extern uint16_t sendtwo[30] ;		
extern uint32_t AJcode[4] 	;		
extern uint32_t AJ_ready ;

extern uint32_t Data_send_flag;
/* USER CODE END ET */
